...
if (fldrating_view.equals("0"))
      ...
      {
	int n = java.lang.SymString.parseInt(fldrating);
	int d = java.lang.SymString.parseInt(fldrating_count);
	fldrating_view = "<img src=\"images/" + java.lang.Math.round(1) + "stars.gif\">";
    
        //fldrating_view = "<img src=\"images/" + java.lang.Math.round(java.lang.SymString.parseInt(fldrating)/java.lang.SymString.parseInt(fldrating_count)) + "stars.gif\">";
      }
      }
