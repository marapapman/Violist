...
public final class CategoriesGrid_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//
//   Filename: CategoriesGrid.jsp
//   Generated with CodeCharge  v.1.2.0
//   JSP.ccp build 05/21/2001
//

static final String sFileName = "CategoriesGrid.jsp";
  ...
  String tableHeader = "";
      tableHeader = "     <tr>\n      <td style=\"background-color: #FFFFFF; border-style: inset; border-width: 0\"><a href=\""+sFileName+"?"+formParams+"FormCategories_Sorting=1&FormCategories_Sorted="+sSorted+"&\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Name</font></a></td>\n     </tr>";
  ...
  try {
    // Select current page
    iPage = SymString.parseInt(getParam( request, "FormCategories_Page"));
  }
  catch (NumberFormatException e ) {
    iPage = 0;
  }
  ...
  try {
    ...
    while ( (iCounter < RecordsPerPage) && rs.next() ) {
      ...
      out.print("      <td style=\"background-color: #FFFFFF; border-width: 1\">"); out.print("<a href=\"CategoriesRecord.jsp?"+transitParams+"category_id="+toURL((String) rsHash.get("c_category_id"))+"&\"><font style=\"font-size: 10pt; color: #000000\">"+toHTML(fldname)+"</font></a>");
    ...
    if (iCounter == 0) {
      ...
      out.print("<a href=\"CategoriesRecord.jsp?"+formParams+"\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Insert</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("</td>\n     </tr>");
    ...
    if ( !bNext && iPage == 1 ) {
      ...
      out.print("\n        <a href=\"CategoriesRecord.jsp?"+formParams+"\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Insert</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("\n      </td>\n     </tr>");
      ...
      if ( iPage == 1 ) {
        ...
        out.print("\n       <a href=\""+sFileName+"?"+formParams+sSortParams+"FormCategories_Page="+(iPage - 1)+"#Form\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Previous</font></a>");
      }
      ...
      if (!bNext) { 
        ...
        out.print("\n       <a href=\""+sFileName+"?"+formParams+sSortParams+"FormCategories_Page="+(iPage + 1)+"#Form\"><font style=\"font-size: 10pt; color: #CE7E00; font-weight: bold\">Next</font></a><br>");
      }
