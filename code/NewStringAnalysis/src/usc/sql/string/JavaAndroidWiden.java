...
public class JavaAndroidWiden {
	...
	public JavaAndroidWiden(String rtjar,String appfolder,String classlist,String apk)
	{		
		InterpretCheckerAndroid(rtjar,appfolder+apk,appfolder+classlist,
					appfolder+"/MethodSummary/",appfolder+"/Output/");
		
	}
	public JavaAndroidWiden(String rtjar,String appfolder,String classlist)
	{
