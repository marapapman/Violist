...
public class JavaApp {
	...
	{
		if(f.startsWith("<org.apache.jsp.ShoppingCart_jsp: java.lang.String toHTML"))
			System.out.println(f);
		if(f.startsWith("<org.apache.jsp.ShoppingCart_jsp: void Total_Show"))
			System.out.println(f);
		if(f.startsWith("<org.apache.jsp.ShoppingCart_jsp: void Items_Show"))
			System.out.println(f);
		if(f.startsWith("<org.apache.jsp.ShoppingCart_jsp: java.lang.String getValueHTML"))
			System.out.println(f);
		if(f.startsWith("<org.apache.jsp.ShoppingCart_jsp: java.lang.String getOptions("))
			System.out.println(f);
	}
			...
			try {
				...
				while ((line = br.readLine()) != null) {
					try{
						...
						{
							if(m.getSubSignature().equals(mainsub))
								entryPoints.add(m);
