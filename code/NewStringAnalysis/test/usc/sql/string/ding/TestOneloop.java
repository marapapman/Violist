...
public class TestOneloop {
	...
	public void test() {
		...
		vlist.add(t);
		ToolKit.Display("./target/classes","usc/sql/string/testcase/IRTestCase1.class","<usc.sql.string.testcase.IRTestCase1: void main(java.lang.String[])>");
